...
function GoalMarket({
  ...
  return (
    <div className="m-auto h-full w-11/12 flex flex-wrap  bg-white">
      <div
        className={`w-full h-1/3 lg:w-1/3 p-4 ${
      ...
      <div
        className={`md:sm:block bg-gray-200 p-4 box-border relative ${
          showStepGoal ? "" : "hidden"
